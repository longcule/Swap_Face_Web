...
def randomGenData(random_case,random_sukien, link_full1, link_full2):
    ...
    try:
            ...
            while True:
                ...
                print("hallooooooo")
                sql = f"INSERT INTO saved_sukien (id_saved ,link_nam_goc , link_nu_goc ,link_nam_chua_swap , link_nu_chua_swap, link_da_swap , thoigian_swap , ten_su_kien , noidung_su_kien , id_toan_bo_su_kien ,so_thu_tu_su_kien, thoigian_sukien, device_them_su_kien, ip_them_su_kien) VALUES ( {result2[0][0] + 1}  ,%s  , %s  ,%s, %s, %s, %s, %s, %s, {result_id_sk[0][0] + 1},{index_vs2}, %s, %s, %s)"
                val = (link_full1, link_full2, list_return_data[index_vs2]["image husband"], list_return_data[index_vs2]["image wife"], list_return_data[index_vs2]["Link_img"], get_id["real_time"], list_return_data[index_vs2]["tensukien"], list_return_data[index_vs2]["thongtin"], date, device_them_su_kien, ip_them_su_kien)
