...
def upload_image_to_imgbb(image_path, api_key):
    ...
    with open(image_path, "rb") as file:
        payload = {
            "key": '2c262849681407817e507b04c2b02a4e',
...
def makeSuKien():
    ...
    print(link_full1)
    # link_full1 = 'https://raw.githubusercontent.com/thuykieu06012002/cutimage/main/nam.101.png'
    # link_full2 = 'https://raw.githubusercontent.com/thuykieu06012002/cutimage/main/nu.101.png'
    config = {
                'user': 'phpmyadmin',
                'password': 'password',
                'host': 'localhost',
    ...
    try:
        ...
        if connection.is_connected():
            ...
            print(id_toan_bo_su_kien)
            print(link_full1, link_full2)
    ...
    if random_case == 1:
        while (True):
            ...
            try:
                ...
                # mycursor.execute(sql, val)
                # random_sukien = ['skchiatay2', 'sknym', 'skhanhphuc', 'skkethon', 'skmuasam', 'sklyhon']
                random_sukien = ['sknym', 'skhanhphuc', 'skkethon', 'skmuasam', 'sklyhon']
                print(random_sukien[index_demo])
    ...
    if random_case == 3:
        while (True):
            ...
            try:
                ...
                random_sukien = [ 'skhanhphuc', 'skmuasam', 'skkethon', 'skchaunoi']
                print(random_sukien[index_demo])
    ...
    if random_case == 4:
        while (True):
            ...
            try:
                ...
                random_sukien = [ 'sknym', 'skhanhphuc', 'skkethon', 'skchaunoi']
                print(random_sukien[index_demo])
    ...
    if random_case == 5:
        while (True):
            ...
            try:
                ...
                random_sukien = ['skhanhphuc', 'skkethon', 'skchaunoi', 'sklyhon', 'skmuasam']
                print(random_sukien[index_demo])
